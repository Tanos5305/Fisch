            ...
            local success, response = pcall(function()
                return (syn and syn.request or http_request) {
                    ...
                    Body = game:GetService('HttpService'):JSONEncode({
                        username = 'B0Z0CK Fisch',
                        avatar_url = 'https://api.deepai.org/job-view-file/d9e4a735-b72d-4e34-89f0-87009bacdc2d/outputs/output.jpg?art-image=true',
                        embeds = { Embed }
                    }),
                }
            end)
...
do
    local _25ms=Tabs.Home:AddButton({
        ...
        Description = "https://discord.gg/GMAuCrhyW3, join for more updates",
        Callback = function()
...
InterfaceManager:SetFolder("B0Z0CK")
SaveManager:SetFolder("B0Z0CK/Fisch")
...
if deviceType == "Mobile" then
    ...
    B.MouseButton1Click:Connect(function()
        local B0Z0CKGui = game.CoreGui:FindFirstChild("ScreenGui") -- Replace with the actual name
        if spaceGui then
